    ...
    return (
        <div className="space-y-6">
            ...
            <Tabs defaultValue="overview" className="w-full">
                <TabsList className="grid w-full grid-cols-5 gap-1 md:w-auto md:grid-cols-none md:inline-flex">
                    <TabsTrigger value="overview">
                        <VenetianMask className="size-5 md:mr-2" />
                        <span className="hidden md:inline">Overview</span>
                    </TabsTrigger>
                    <TabsTrigger value="balances">
                        <Users className="size-5 md:mr-2" />
                        <span className="hidden md:inline">Balances</span>
                    </TabsTrigger>
                    <TabsTrigger value="history">
                        <History className="size-5 md:mr-2" />
                    ...
                    <TabsTrigger value="chat">
                        <MessageSquare className="size-5 md:mr-2" />
